...
const Grade12AttChart = ({ data }) => {
    ...
    const chartOptions = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: '1-2학년 과목별 출석률 평균 (2025년 이전 vs 2025년)',
                font: {
                    size: 18,
                },
                color: '#333',
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md mt-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-700">1-2학년 과목별 출석 현황</h3>
            {hasData ? (
                <Bar options={chartOptions} data={dataForChart} />
            ) : (
                <p className="text-gray-600">1-2학년 과목 출석 데이터가 없습니다.</p>
            )}
        </div>
    );
};

export default Grade12AttChart;