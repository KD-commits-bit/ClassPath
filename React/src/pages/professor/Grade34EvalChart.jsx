...
const Grade34EvalChart = ({ data }) => {
    ...
    const chartOptions = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: '3-4학년 과목별 강의평가 평균 (2025년 이전 vs 2025년)',
                font: {
                    size: 18,
                },
                color: '#333',
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md mt-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-700">3-4학년 과목별 강의평가 현황</h3>
            {hasData ? (
                <Bar options={chartOptions} data={dataForChart} />
            ) : (
                <p className="text-gray-600">3-4학년 과목 강의평가 데이터가 없습니다.</p>
            )}
        </div>
    );
};

export default Grade34EvalChart;