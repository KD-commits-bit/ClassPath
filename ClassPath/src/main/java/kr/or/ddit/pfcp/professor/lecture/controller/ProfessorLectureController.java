...
public class ProfessorLectureController {
	...
	public String lectureDetail(
		...
		LectureReqVO lectureReq = professorLectureService.readLecDetail(no);
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"+lectureReq);
...
//	    LectureReqVO lectureReq = professorLectureService.readLectureDetail(reqNo);
	    LectureReqVO lectureReq = professorLectureService.readLecDetail(reqNo);
