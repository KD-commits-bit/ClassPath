...
public class StudentNoticeController {
  ...
  public String goNoticeList(
    ...
    try {
        ...
        int totalRecordCount = noticeService.readTotalCount(paramMap);
        
        paging.setTotalRecordCount(totalRecordCount);
        
        
        List<BoardVO> board = noticeService.readBoardList(paramMap);
  ...
  public String noticeInsertProcessUI(
      ...
      try {
          ...
          if(!errors.hasErrors()) {
              ...
              return "redirect:/student/notice/studentNoticeList.do";
