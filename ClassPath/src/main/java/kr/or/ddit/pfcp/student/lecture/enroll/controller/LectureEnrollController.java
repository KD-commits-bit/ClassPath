...
@Controller
@Slf4j
@RequestMapping("/student/lecture/enroll.do")
public class LectureEnrollController {
    ...
    public String enrollMain(
            ...
            @RequestParam(required = false) String lecName,
    		Model model,
    	...
    	log.info("{}>>>>>>>>>>",lecName);
    	 ...
    	 List<LectureVO> lecList = enrService.readLectureList(userNo, departmentNo, day, period, credit, lecName);
    	 ...
    	 String notice = "";
    	 if(schedule!=null) {
    		 notice = String.format("2025학년도 수강신청 기간은 %s ~ %s입니다.",
	 ...
	 * // 2. 수강 정정 화면
	 * 
	 * @GetMapping("/edit") public String editPage() { return
	 * "pfcp/student/lecture/editPage"; } // 3. 수강 정정 처리
	 * 
	 * @PutMapping("/edit") public String processEdit(@RequestParam("lectureId")
	 * Long lectureId) {
	 * 
	 * 
	 * return "redirect:/student/lecture/enroll.do"; }
	 */
