...
public interface CollegeMapper {
	public CollegeVO selectColleageName(String collegeNo);

	public List<CollegeVO> selectAllCollegeList();
	
	public CollegeVO selectCollege(String collegeNo);
	...
	public CollegeVO selectCollegeByCollegeNo(String collegeNo);
}
