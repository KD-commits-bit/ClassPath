...
public class GrademanageController {
	...
	public String grademanageListUI(
		...
		if (keyword != null && !keyword.trim().isEmpty()) {
			totalRecordCount = staffLectureService.readLectureTotalCountByKeyword(paramMap);
		} else {
			totalRecordCount = staffLectureService.readLectureTotalCount();
		}
		...
		List<LectureVO> lecture = staffLectureService.readLectureList(paramMap);
	...
	public String grademanageDetailUI(
		...
		List<GradeVO> lectureStudent = grademanageService.readStuGrade(what);
		int totalCount = lectureStudent.size();
