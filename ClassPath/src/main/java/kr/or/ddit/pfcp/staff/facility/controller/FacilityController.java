...
public class FacilityController {
	...
	public String facilityListUI(
		...
		paramMap.put("facilityStatus", facilityStatus);
		
		if ((facilityStatus != null && !facilityStatus.trim().isEmpty()) || (keyword != null && !keyword.trim().isEmpty())) {
			totalRecordCount = service.readFacilityTotalCountByKeyword(paramMap);
		} else {
			totalRecordCount = service.readFacilityTotalCount();
		}
		...
		List<FacilityVO> facility = service.readFacilityList(paramMap);
