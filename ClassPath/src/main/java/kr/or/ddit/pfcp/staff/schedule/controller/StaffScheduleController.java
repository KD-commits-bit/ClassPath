...
public class StaffScheduleController {
	...
	public String scheduleMain(
		...
		String userRole = user.getRealUser().getUserRole();
	...
	public ScheduleVO getScheduleDetail(
		...
		ScheduleVO schedule = scheduleService.getSchedule(scheduleNo);
		return schedule;
	}
	...
	public String saveSchedule(
		...
		if (startDate.isAfter(endDate)) {
		    ...
		    return "redirect:/schedule.do/form";
		}
		...
		if ("insert".equals(formMode)) {
			...
			if(result>0 && isNotice) {
				...
				if(updateBoard != null) {
			        ...
			        newBoard.setWriterNo(userno); // 임시 (로그인 적용 전)
