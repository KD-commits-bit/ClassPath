...
public class ConsultController { // ConsultController로 통일
    ...
    public String consultScheduleListUI(
    		Model model,
		...
		if (keyword != null && !keyword.trim().isEmpty()) {
			totalRecordCount = professorService.readProfessorTotalCountByKeyword(paramMap);
		} else {
			totalRecordCount = professorService.readProfessorTotalCount();
		}
        ...
        List<ProfessorVO> professorList = professorService.readProfessorList(paramMap);
