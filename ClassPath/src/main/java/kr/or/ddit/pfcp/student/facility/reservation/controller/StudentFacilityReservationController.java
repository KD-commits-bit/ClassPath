...
public class StudentFacilityReservationController {
   ...
   public String reserveForm(
     ...
     List<FacilityReservationVO> myReservations = facilityReservationService.readFacilityReservationByUserNo(authentication.getName());
...
// 예약 요청 처리 (POST)
   ...
   public ResponseEntity<Map<String, Object>> cancelReservation(
       ...
       String username = principal.getName(); // 현재 로그인된 사용자 ID

       try {
           boolean success = facilityReservationService.cancelReservation(reservationNo, username);
