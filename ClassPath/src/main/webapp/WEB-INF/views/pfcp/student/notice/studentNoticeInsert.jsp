...
<div class="container">
	...
	<div class="detail-section">
		<form id="noticeRegisterForm" enctype="multipart/form-data" action="/student/notice/noticeInsertProcess.do" method="post">
...
<!-- 			<input type="file" id="noticeAttachments" name="attachments" multiple> -->
		...
		<button type="button" class="btn-secondary" onclick="fillDemoNotice()">데모 데이터 입력</button>
	</div>
</div>
