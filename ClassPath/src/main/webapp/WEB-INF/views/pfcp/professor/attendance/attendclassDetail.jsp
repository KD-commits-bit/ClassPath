...
<div class="section">
	<div class="card">
		<form style="display:contents"> 
            ...
            <button type="button" class="cancelButton" onclick="location.href='/professor/attendance/attendclassList.do'" style="float:left; margin-right:20px; width:7%">목록으로</button>
		</form>
	</div>
