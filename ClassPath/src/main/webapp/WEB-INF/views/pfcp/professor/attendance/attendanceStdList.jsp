...
<form id="attendanceForm" method="post" action=""  style="display:contents;">
    ...
    <div style="justify-content:space-between;">
        ...
        <button type="button" class="cancelButton" onclick="location.href='/professor/attendance/attendclassList.do'">목록으로</button>
    </div>
