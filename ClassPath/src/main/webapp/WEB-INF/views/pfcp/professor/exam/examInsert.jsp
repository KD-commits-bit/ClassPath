...
<div class="section">
	<div class="card">
		<form method="post" enctype="multipart/form-data" action="/professor/exam/examInsertProcess.do" style="display:contents;">
			...
			<div class="button-group" style="display: flex; justify-content: space-between; align-items: center;">
			    ...
			    <!-- 오른쪽: 저장 / 취소 버튼 -->
			    <div>
			        <button class="deleteButton" type="reset" style="margin-right: 10px;">취소</button>
