...
<script src="/js/app/pfcp/professor/examDetail.js"></script>
...
<div class="section">
	<div class="card">
		<form method="post" enctype="multipart/form-data" action="/professor/exam/examUpdateProcess.do" style="display:contents;">
