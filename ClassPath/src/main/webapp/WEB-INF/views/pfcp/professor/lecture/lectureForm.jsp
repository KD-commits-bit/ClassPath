...
<div class="section">
    <div class="card">
        ...
        <button type="button" onclick="fillDemoLectureForm()" class="submitButton" style="float: left; background-color: gray; margin-top: 10px;">
    데모 입력
</button>
            <button type="reset" class="deleteButton" style="float:right;" onclick="location.href='/professor/lecture/lectureList.do'">취소</button>
