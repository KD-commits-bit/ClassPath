...
<div class="sectionHeaderLine">
	...
	<c:if test="${not empty college}">
        <div class="sectionHeaderTitle">${college.collegeName}</div>
    </c:if>
							...
							<div class="lecture-item-content">
								<div class="lecture-info-group">
									<div class="lecture-icon-wrapper">
										<svg xmlns="http://www.w3.org/2000/svg" class="lecture-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
