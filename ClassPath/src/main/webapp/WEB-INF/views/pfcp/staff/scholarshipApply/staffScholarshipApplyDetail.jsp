...
<!-- <link rel="stylesheet" href="/dist/assets/css/test/staffScholarshipApplyDetail2.css">  -->
...
<div class="staffScholarshipDetail">
	<div class="form-container">
	    ...
	    <form method="post" enctype="multipart/form-data" action="/staff/scholarshipApply/staffScholarshipUpdateProcess.do">
				...
				<table class="defaultTable">
					<tbody>
						...
						<tr >
							...
							<td class="tableTd" style="text-align:left;" colspan="3">
	        ...
	        <div class="button-group" style="display:flex; justify-content:space-between; width:100%">
...
<style>
.staffScholarshipDetail .cancelButton {
    background: #718096;
    color: #ffffff;
    border: none;
    padding: 12px 24px;
...
.staffScholarshipDetail .cancelButton:hover {
    background: #4a5568;
