...
<link rel="stylesheet" href="/dist/assets/css/test/staffDetail2.css">
...
<div class="staffDetail">
	<form action="/staff/staffmanage/staffUpdateProcess.do" method="post" style="display:contents;">
					...
					<tr class="tableRowHover">
						...
						<td class="tableTd">
							<div class="input-with-icon"> <%-- Changed class name for clarity --%>
								<input type="text" name="user.userZip" id="sample4_postcode" class="inputField" placeholder="우편번호" readonly value="${staff.user.userZip}"/>
		...
		<div style="margin-top:20px; display: flex; justify-content: space-between; gap: 10px;">
		    ...
		    <div>
			    <button type="button" class="deleteButton" onclick="updateRdate()" style="margin-top:15px">퇴직 처리</button>
