...
<div class="studentInsert">
	<form method="post" action="/staff/studentmanage/studentInsertProcess.do" style="display:contents;">
	<h1>학생 등록</h1>
    <hr class="h1-hr">
			...
			<table class="defaultTable">
				<tbody>
					...
					<tr class="tableRowHover">
						...
						<td class="tableTd">
							<select id="departmentNo" name="departmentNo" class="selectBox" data-init-val="${staff.department.departmentNo }">
					...
					<tr class="tableRowHover">
						...
						<td class="tableTd">
							<div class="input-with-icon"> <%-- Changed class name for clarity --%>
								<input type="text" name="user.userZip" id="sample4_postcode" class="inputField" placeholder="우편번호" readonly />
		...
		<div style="margin-top:20px;" style="display:flex; justify-content:spcae-between">
