...
<link rel="stylesheet" href="/dist/assets/css/test/lectureEvaluationForm2.css">
...
<div class="lectureEvaluationForm">
	<form method="post" action="/staff/lectureEvaluation/lectureEvalutaionFormUpdateProcess.do" style="display:contents;">
	<div class="form-section">
		<!-- ======================================== -->
		<div class="sectionHeaderLine">
		  <div>
		    <div class="sectionHeaderTitle">강의평가 질문 목록</div>
		    <div class="sectionHeaderDescription">강의평가 질문을 관리할 수 있습니다.</div>
		  </div>
				...
				<div class="card" style="padding: 1.25rem; margin-top: 1rem;">
					<c:forEach items="${lectureEvaluation}" var="lectureEvaluation" varStatus="status">
						<div class="question-item" data-criteria-no="${lectureEvaluation.criteriaNo }" data-criteria-desc="${lectureEvaluation.criteriaDesc }" style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
							<label class="inputLabel" style="width:50px; text-align:center; color:#2b6cb0 !important">${status.index+1 }</label>
