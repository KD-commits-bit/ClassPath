...
<link rel="stylesheet" href="/dist/assets/css/test/staffScholarshipList2.css">
...
<div class="staffScholarshipList">
	<!-- ======================================== -->
				...
				<c:choose>
					<c:when test="${not empty scholarshipTypeList}">
						<c:forEach items="${scholarshipTypeList}" var="item" varStatus="status">
							...
							<tr class="tableRowHover" data-type-no="${item.schTypeNo }">
								...
								<td class="tableTd" style="text-align:center;">
									<!-- 장학금 신청 목록 버튼 -->
									<button type="button" class="cancelButton" onclick="moveToApplyList('${item.schTypeNo}')">
										바로가기
									</button>
								</td>
...
function moveToApplyList(schTypeNo){
