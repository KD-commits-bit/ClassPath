...
<title>부엉대학교 학생포털 - 메인</title>
<link
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
	rel="stylesheet">
<!-- <link href="/dist/assets/css/index.css" rel="stylesheet" /> -->
<link href="/dist/assets/css/test/index2.css" rel="stylesheet" />
</head>
<body>
	<div class="indexContainer">
		<!-- Header -->
		<div class="header">
			<div class="left-section" style="cursor:pointer;" onclick="window.location.href='/student/schedule';">
                <div class="icon-item" >
                    <i class="far fa-calendar-alt icon"></i>
                    <div class="text">Schedule</div>
                    <div class="sub-text">오늘의 일정</div>
                </div>
            </div>
		...
		<div class="quick-actions">
			<a href="http://localhost:6060/eclass/assignmentList/${student.userNo}"
...
<%-- 			<a class="quick-action" href="http://localhost:6060/eclass/lecture/<sec:authentication property="principal.username"/>" > <i --%>
...
<!-- 			</a> -->
			...
			</a> <a href="/student/facility/studentFacilityList.do" class="quick-action"> <i
